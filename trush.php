    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <table id="userTable" class="table table-striped w-100">
                ...
                <tbody>
                    <?php 
                       $sql = "SELECT * FROM all_user WHERE status = '0' ORDER BY id DESC";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="" data-bs-toggle="modal" data-bs-target="#restore<?php echo $id?>"><i class="bi bi-arrow-repeat ms-2"></i></a>
                            </div>
                        </td>
                    </tr>
                    <!-- Modal for restore -->
                    <div class="modal fade" id="restore<?php echo $id?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Are You Sure Restore <span class="text-warning"><?php echo $name; ?></span></h1>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a type="button" href="trush.php?restore=<?php echo $id; ?>" class="btn btn-warning">Confirm</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary"
                                        data-bs-dismiss="modal">Close</button>
                                    <a type="button" href="trush.php?did=<?php echo $id; ?>" class="btn btn-warning">Confirm</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <?php
            ...
            if(isset($_GET['restore'])){
                ...
                $sql = "UPDATE all_user SET status = '1' WHERE id = '$restore'";
                $query = mysqli_query($db, $sql);

                if($query){
                    header("Location:trush.php");
                }else{
            ...
            if(isset($_GET['did'])){
                $did = $_GET['did'];
                $sql = "DELETE FROM all_user WHERE id = '$did'";
                $query = mysqli_query($db, $sql);
